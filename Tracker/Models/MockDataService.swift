...
class MockDataService {
    ...
    func getDummyTrackers() -> [TrackerCategory] {
        ...
        let tracker1 = Tracker(id: UUID(), name: "Полив растений", color: "colorSelection1", emodji: "🦖", schedule: schedule1, creationDate: Date(), originalCategory: nil)
        let tracker2 = Tracker(id: UUID(), name: "Йога", color: "colorSelection12", emodji: "🧘‍♀️", schedule: schedule2, creationDate: Date(), originalCategory: nil)
        let tracker3 = Tracker(id: UUID(), name: "14 спринт", color: "colorSelection7", emodji: "👹", schedule: schedule3, creationDate: Date(), originalCategory: nil)
        let tracker4 = Tracker(id: UUID(), name: "Теннис", color: "colorSelection5", emodji: "🎾", schedule: schedule1, creationDate: Date(), originalCategory: nil)
